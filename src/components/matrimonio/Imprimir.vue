    ...
    padresEsposo() {
      if (this.matrimonio) {
        if (this.matrimonio.esposo.padre && this.matrimonio.esposo.madre)
          return (
            this.matrimonio.esposo.padre +
            " y de " +
            this.matrimonio.esposo.madre
          );
        return this.matrimonio.esposo.padre
          ? this.matrimonio.esposo.padre
          : this.matrimonio.esposo.madre;
      }
      return "";
    ...
    padresEsposa() {
      if (this.matrimonio) {
        if (this.matrimonio.esposa.padre && this.matrimonio.esposa.madre)
          return (
            this.matrimonio.esposa.padre +
            " y de " +
            this.matrimonio.esposa.madre
          );
        return this.matrimonio.esposa.padre
          ? this.matrimonio.esposa.padre
          : this.matrimonio.esposa.madre;
      }
      return "";
