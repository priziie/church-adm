<template>
    ...
    <div class="form-style-2-heading">Agregar nueva acta de matrimonio</div>
...
export default {
    ...
    methods:{
        ...
        add: function(){
            ...
            // console.log(object);
            http.post('matrimonio', this.object,{
                headers: {
            ...
            .then((response) =>{
                ...
                if(response.status != 200){
                    ...
                    this.object.pagina= '';
                    this.object.fecha = '';
                    this.object.esposo.nombre= '';
                    this.object.esposo.edad= '';
                    this.object.esposo.madre= '';
                    this.object.esposo.padre= '';
                    this.object.esposo.testigo= '';
                    this.object.esposo.origen= '';
                    this.object.esposa.nombre= '';
                    this.object.esposa.edad= '';
                    this.object.esposa.madre= '';
                    this.object.esposa.padre= '';
                    this.object.esposa.testigo= '';
                    this.object.esposa.origen= '';
                }
            })
            .catch((error) => {
